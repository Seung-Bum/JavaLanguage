...
public class ListController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        int pageSize = Integer.parseInt(application.getInitParameter("POSTS_PER_PAGE")); // WEB-INF/lib/web.xml 10
        int blockPage = Integer.parseInt(application.getInitParameter("PAGES_PER_BLOCK")); // 5

        // 현재 페이지 확인
        int pageNum = 1;  // 기본값
        String pageTemp = req.getParameter("pageNum"); // 요청페이지가 없다면 기본값으로 진행
