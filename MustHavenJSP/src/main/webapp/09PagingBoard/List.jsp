...
<%
// DAO를 생성해 DB에 연결
// application으로 DB 연결(web.xml)
BoardDAO dao = new BoardDAO(application);

// 사용자가 입력한 검색 조건을 Map에 저장
Map<String, Object> param = new HashMap<String, Object>(); 
String searchField = request.getParameter("searchField"); // 사용자가 입력한 값
String searchWord = request.getParameter("searchWord");
if (searchWord != null) { // 사용자가 입력을 했을 경우에만 request 보냄
    param.put("searchField", searchField); // 키, 값
...
%>
    ...
    <!-- 
    	...
    	blockPage : 블록 페이지 범위
    	pageNum : 현재 페이지 번호
    	request.getRequestURI() : 실행된 목록 파일명
     -->
    <table border="1" width="90%">
        <tr align="center">
        	<!-- 페이징 처리 -->
