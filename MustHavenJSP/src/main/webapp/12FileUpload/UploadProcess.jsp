...
try {
    // 1. MultipartRequest 객체 생성 (HttpServletRequest request)
    ...
    // 7. 파일 목록 JSP로 리디렉션
    // 저장 성공시 FileList.jsp로 이동하게 된다.
    response.sendRedirect("FileList.jsp");
}
catch (Exception e) {
    e.printStackTrace();
    request.setAttribute("errorMessage", "파일 업로드 오류");
    request.getRequestDispatcher("FileUploadMain.jsp").forward(request, response); //문제 발생시 이동
}
%>
